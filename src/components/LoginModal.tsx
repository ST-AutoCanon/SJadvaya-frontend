    ...
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50 px-6">
      ...
      >
        ...
        <div className="flex justify-center mb-6">
          <img src="/logodark.png" alt="Logo" className="h-20 w-auto" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full bg-green-600 hover:opacity-90 text-white py-3 rounded-xl font-semibold shadow-lg transition-all duration-300"
          >
            Login
          </button>
        </form>
