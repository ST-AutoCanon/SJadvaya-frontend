      ...
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="overflow-auto max-h-[420px] border rounded-lg shadow-sm bg-white">
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              {[
                ["1", "Vehicle type", "Category", "L5"],
                ["2", "Dimensions", "L x B x H", "3.2m x 1.2m x 1.8m"],
                ["3", "Kerb Weight", "Kgs", "450"],
                ["4", "Payload", "Kgs", "600"],
                ["5", "Gross Weight", "Kgs", "1050"],
                ["6", "Carriage Type", "Type", "Fixed / Tilting"],
                ["7", "Range - Max Distance", "Km", "80 km"],
                ["8", "Charging Time", "Hrs", "4 hrs"],
                ["9", "Max Speed", "Km/hr", "45 kmph"],
                ["10", "Motor Power (BLDC)", "Kw", "5 Kw, 72V"],
                ["11", "Controller (BLDC)", "", "72V, 100A"],
                ["12", "Battery (LFP)", "Kwh", "7.5 Kwh (72V 105Ah)"],
                ["13", "Rear Carriage", "", "Heavy Duty Fabricated"],
                ["14", "Rear Axle", "Inch", "Heavy Duty Differential"],
                ["15", "Rear View Mirror", "", "Fixed"],
                ["16", "Hand Brake", "", "Yes"],
                ["17", "Head Light", "LED", "Dual Lamp"],
                ["18", "Display", "LED", "Digital Display"],
                ["19", "Tyres", "Inch", "4.00 x 12"],
                ["20", "Charger", "V/A", "72V, 20A External"],
                ["21", "USB Charger", "", "Yes"],
              ].map((row, i) => (
